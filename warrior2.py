...
def warrior2(name_posture, output_name, is_old=False):
    ...
    # clean outliers
    if len(data) > 1:
        data = data[data['elbow_right_angle'] > 160]
        data = data[data['elbow_left_angle'] > 160]
        data = data[data['hip_angle_left'] > 90]
        data = data[data['hip_angle_right'] > 90]
        data = data[(data['sholder_angle_left'] > 75) &
                    (data['sholder_angle_left'] < 110)]
        data = data[(data['sholder_angle_right'] > 75) &
                    (data['sholder_angle_right'] < 110)]
        data = data[(data['knee_right_angle'] > 90) &
                    (data['knee_left_angle'] > 90)]
        data = data[(data['knee_right_angle'] < 130) |
                    (data['knee_left_angle'] < 130)]
